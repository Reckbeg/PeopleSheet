...
function buildLeaveTracker(workbook: ExcelJS.Workbook, template: TemplateProduct) {
  ...
  title(balance, "Leave Balance", "Track annual entitlement, approved usage, and remaining balance.");
  addHeader(balance, 4, [
    "Employee No.",
    "Employee Name",
    "Department",
  ...
  title(usage, "Leave Usage", "Log requests and keep Approved rows as the source of truth.");
  addHeader(usage, 4, [
    "Employee No.",
    "Employee Name",
    "Leave Type",
