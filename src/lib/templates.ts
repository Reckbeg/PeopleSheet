...
export const templates: TemplateProduct[] = [
  {
    ...
    category: "Attendance",
    summary: "Matriks absensi bulanan dengan tanggal otomatis dan penanda akhir pekan.",
    detail:
      "Template absensi yang ringan untuk tim yang masih mengelola status harian di Excel atau Google Sheets.",
    fileName: "peoplesheet-attendance-tracker.xlsx",
    downloadLabel: "Unduh template absensi",
    ...
    useCase: "Pencatatan absensi harian di spreadsheet bersama",
  ...
  },
  {
    ...
    category: "Tax",
    summary: "Kalkulator pajak penghasilan PPh21 Indonesia dengan lapisan tarif progresif dan status PTKP.",
    detail:
      "Hitung potongan pajak PPh21 bulanan untuk setiap karyawan menggunakan tarif progresif Indonesia, potongan BPJS, dan pilihan status PTKP.",
    ...
    features: [
      "Tarif progresif PPh21 Indonesia (5%–35%)",
      "Dropdown status PTKP (TK/0 sampai K/3)",
      "Perhitungan potongan BPJS otomatis",
      "Rumus potongan PPh21 bulanan",
    ],
    preview: [
      "Atur tahun pajak dan pilih status PTKP per karyawan di Setup.",
      "Sheet Tax Brackets mendefinisikan tarif progresif 5 tingkat.",
      "Sheet Employee Tax menghitung gaji kotor tahunan, potongan, penghasilan kena pajak, dan PPh21 bulanan.",
      "Sheet Summary menunjukkan total kewajiban pajak per karyawan.",
    ],
    previewSheets: [
      {
        name: "Setup",
        description: "Tahun pajak, daftar status PTKP, jumlah PTKP",
      },
      {
        name: "Tax Brackets",
        description: "Tabel tarif progresif PPh21 (5%, 15%, 25%, 30%, 35%)",
      },
      {
        name: "Employee Tax",
        description: "Gaji kotor, potongan, penghasilan kena pajak, PPh21 bulanan",
      },
      {
        name: "Summary",
        description: "Total pajak tahunan dan bulanan per karyawan",
      },
    ],
    operationalNotes: [
      "Kompatibel dengan Excel 2016+ dan Google Sheets",
      "Menggunakan tarif pajak progresif PPh21 Indonesia yang sebenarnya",
      "Potongan BPJS dihitung otomatis dari gaji kotor",
      "Dropdown status PTKP untuk kemudahan pengisian",
    ...
    previewData: {
      title: "Ringkasan Pajak Karyawan",
      headers: [
        "Karyawan",
        "Divisi",
        "Gaji Kotor",
      ...
      rows: [
        ["Dina Prasetya", "Operasional", 7500000, "TK/0", 55800000, 172500],
        ["Rafi Mahendra", "HR", 12000000, "K/1", 105600000, 525000],
        ["Sari Wulandari", "Keuangan", 6800000, "K/0", 49680000, 124000],
        ["Budi Santoso", "Operasional", 5500000, "TK/0", 37200000, 60000],
        ["Maya Anggraini", "Keuangan", 6200000, "K/0", 42480000, 87000],
      ],
    },
  },
  {
